<div class="row">
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="margin-bottom: 45px;">
		<div class="x_panel">
			...
			<div class="x_content">
				{!! Form::open(['route' => $ruta["search"], 'method' => 'POST' ,'onsubmit' => 'return false;', 'class' => 'form-inline', 'style' => 'text-align:center;', 'role' => 'form', 'autocomplete' => 'off', 'id' => 'formBusqueda'.$entidad]) !!}
				...
				<div class="form-group">
					...
					{!! Form::select('menuoptioncategory_id', $cboCategoria, null, array('class' => 'form-control input-sm', 'id' => 'menuoptioncategory_id' , 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
				</div>
				<div class="form-group">
				...
				{!! Form::button('<i class="glyphicon glyphicon-plus"></i> Nuevo', array('class' => 'btn btn-success waves-effect waves-light m-l-10 btn-sm', 'style' => 'margin-top: 5px;' ,  'id' => 'btnNuevo', 'onclick' => 'modal (\''.URL::route($ruta["create"], array('listar'=>'SI')).'\', \''.$titulo_registrar.'\', this);')) !!}
				{!! Form::close() !!}
				<div class="col-lg-1 col-md-1"></div>
