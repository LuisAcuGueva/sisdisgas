	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="col-lg-3 col-md-3 col-sm-3" id="divDatosDocumento1">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 m-b-15" style="margin-top: 10px;">
				...
				{!! Form::text('cliente', $pedido->persona->apellido_pat.' '.$pedido->persona->apellido_mat.' '.$pedido->persona->nombres, array('class' => 'form-control input-sm', 'id' => 'cliente', 'readOnly')) !!}
				@else
